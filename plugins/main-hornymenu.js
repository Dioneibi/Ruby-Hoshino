...
const handler = async (m, { conn, usedPrefix, usedPrefix: _p, __dirname, text, isPrems }) => {
  if (!db.data.chats[m.chat].modohorny && m.isGroup) {
    // Enviar el archivo de audio cuando el comando está desactivado
    return conn.sendFile(m.chat, './media/Medasascopierdete.mp3', 'Medasascopierdete.mp3', null, m, true, { type: 'audioMessage', ptt: true });
  }
