...
let Ruby = `🚩 *Respeta las reglas de Ruby*\n
✰ No llamar Al Bot
✰ No hacer spam
...
⚠️ 𝗔𝘃𝗶𝘀𝗼: *Puedes apoyarnos dejando una estrellita 🌟 al repositorio oficial de Ruby-Hoshino.*

${global.md}`.trim()
await conn.reply(m.chat, Ruby, m, rcanal, )
