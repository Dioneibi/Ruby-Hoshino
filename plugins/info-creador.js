...
let biografia = await conn.fetchStatus('18096758983' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `☁️ nevigamer`, dev, 'nevihost9@gmail.com', `RD`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Una Bot 🤍`, `${packname}`, `📵 No Hacer Spam`, 'nevihost9@gmail.com', `RD`, `https://github.com/nevi67/VermeilBot-MD`, biobot]
], m)
