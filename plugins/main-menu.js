...
“ Hola *%name*, mi nombre es *VermeilBot*, Cómo se encuentra el día de hoy?  ”
...
const pp = await conn.profilePictureUrl(who, 'image').catch(_ => 'https://telegra.ph/file/5fd686d0cbb2ac194ab56.jpg')
...
await conn.sendFile(m.chat, imagen1, '5fd686d0cbb2ac194ab56.jpg', text.trim(), fkontak, null, rcanal)
